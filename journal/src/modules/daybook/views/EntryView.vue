<template>
  ...
  <img
    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGwhuLu9lKPawHuEGz_a09p91OEGrV5IZM4H11PymLkOhHbKgbHVUN6ccBemRky4Viiq4&usqp=CAU"
    alt="img"
    class="img-thumbnail"
  />
</template>
...
img {
  ...
  bottom: 150px;
  right: 20px;
  box-shadow: 0px 5px 18px rgba($color: #000000, $alpha: 8.2);
}
</style>
